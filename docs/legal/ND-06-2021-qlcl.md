...
_(Ban hành kèm theo Nghị định số_ _06 **/202** 1\_\_/NĐ-CP_
...
| Người lập*(Ghi rõ họ tên, chức vụ, chữ ký)*      | Chỉ huy trưởng công trình hoặc giám đốc dự án*(Ghi rõ họ tên, chữ ký)* | Tư vấn giám sát trưởng*(Ghi rõ họ tên, chức vụ, chữ ký )* |

_ **Ghi chú** \_\_: không áp dụng hình thức hợp đồng tổng thầu xây dựng thi công xây dựng. Kích thước dấu tùy thuộc kích cỡ chữ._
...
| --------------------------------------------------------- | ----------------------------------------------------------------------------- | ------------------------------------------------------------------------- | --------------------------------------------------------- |
| **BẢN VẼ HOÀN CÔNG\*\*** Ngày….. \***\* tháng….. năm…..** |
| Người lập*(Ghi rõ họ tên, chức vụ, chữ ký)*               | Chỉ huy trưởng hoặc giám đốc dự án của nhà thầu phụ _(Ghi rõ họ tên, chữ ký)_ | Chỉ huy trưởng hoặc giám đốc dự án của tổng thầu*(Ghi rõ họ tên, chữ ký)* | Tư vấn giám sát trưởng*(Ghi rõ họ tên, chức vụ, chữ ký )* |

_ **Ghi chú** \_\_: áp dụng hình thức hợp đồng tổng thầu xây dựng thi công xây dựng. Kích thước dấu tùy thuộc kích cỡ chữ._
...
| _Nơi nhận: **- Như trên;** - Lưu …;\_\_- Hồ sơ gửi kèm (4)_ | **NGƯỜI ĐẠI DIỆN THEO QUY ĐỊNH PHÁP LUẬT CỦA CHỦ ĐẦU TƯ** _(Ký, ghi rõ họ tên, chức vụ và đóng dấu pháp nhân)_ |
| ----------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
